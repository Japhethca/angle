...
%{
  ...
  subagents: [
    ...
    %{
      name: "Ash Expert",
      description:
        "MUST BE USED for Ash Framework tasks: resource creation, domain modeling, relationships, actions, calculations, and validations. Use PROACTIVELY for any Ash-specific development.",
      prompt: """
      # Purpose
      ...
      tools: [
        ...
        :grep,
        :glob,
        :mcp__tidewave_1__project_eval,
        :mcp__tidewave_1__get_ecto_schemas
      ]
    },
    %{
      name: "React Component Builder",
      description:
        "MUST BE USED for React component creation, TypeScript interfaces, Shadcn UI integration, and frontend component architecture. Use PROACTIVELY for any React/TypeScript development.",
      prompt: """
      # Purpose
    ...
    %{
      ...
      tools: [
        ...
        :grep,
        :mcp__tidewave_1__project_eval,
        :mcp__tidewave_1__execute_sql_query
      ]
    },
    %{
